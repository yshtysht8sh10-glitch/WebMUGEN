...
| HitDef | Partial | CNS runtime applies `damage`, `ground.hittime`, and `air.hittime` through a limited ActiveHitDef. Other HitDef/get-hit parameters remain incomplete. |
