...
describe('CnsRuntimeTrigger', () => {
  ...
  it('evaluates constants and misc numeric triggers', () => {
    ...
    expect(evaluateCnsRuntimeTrigger('ProjHit1005 = 1, < 15', { player, projHitTime: (id) => id === 1005 ? 14 : -1 })).toBe(true);
    expect(evaluateCnsRuntimeTrigger('ProjHit = 1', { player, projHitTime: (id) => id === 0 ? 1 : -1 })).toBe(true);
